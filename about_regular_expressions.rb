...
class AboutRegularExpressions < Neo::Koan
  ...
  #
  # Why?
  # The * is used to match and return as many possible characters from the input.
  # Have to be careful when using this as since it'll grab as much data as it can you might end up with more than what you want.
  # Performs a lot of backtracking to get result.
  ...
  # Alternation works on entire regexp captures; character classes just work on characters.
